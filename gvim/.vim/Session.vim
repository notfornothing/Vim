...
set incsearch
set laststatus=2
set runtimepath=~/vimfiles,~\\.vim\\plugged\\nerdtree,~\\.vim\\plugged\\nerdcommenter,~\\.vim\\plugged\\dracula,~\\.vim\\plugged\\vim-airline,~\\.vim\\plugged\\vim-airline-themes,~\\.vim\\plugged\\fzf,~\\.vim\\plugged\\vim-highlightedyank,~\\.vim\\plugged\\vim-surround,~\\.vim\\plugged\\argtextobj.vim,C:\\Program\ Files\\Vim/vimfiles,C:\\Program\ Files\\Vim\\vim82,C:\\Program\ Files\\Vim/vimfiles/after,~\\.vim\\plugged\\dracula\\after,~/vimfiles/after
set showtabline=2
set smartcase
set noswapfile
...
silent! normal! zE
let &fdl = &fdl
let s:l = 152 - ((19 * winheight(0) + 20) / 40)
