...
" autocmd Filetype markdown nnoremap <buffer> <Space>f <Esc>/<++><CR>:nohlsearch<CR>"_c4l
" autocmd Filetype markdown nnoremap <buffer> <Space>w <Esc>/ <++><CR>:nohlsearch<CR>"_c5l<CR>
" autocmd Filetype markdown nnoremap <buffer> <Space>n ---<Enter><Enter>
" autocmd Filetype markdown nnoremap <buffer> <Space>b **** <++><Esc>F*hi
" autocmd Filetype markdown nnoremap <buffer> <Space>s ~~~~ <++><Esc>F~hi
" autocmd Filetype markdown nnoremap <buffer> <Space>i ** <++><Esc>F*i
" autocmd Filetype markdown nnoremap <buffer> <Space>d `` <++><Esc>F`i
" autocmd Filetype markdown nnoremap <buffer> <Space>c ```<Enter><++><Enter>```<Enter><Enter><++><Esc>4kA
" autocmd Filetype markdown nnoremap <buffer> <Space>m - [ ]
" autocmd Filetype markdown nnoremap <buffer> <Space>p ![](<++>) <++><Esc>F[a
" autocmd Filetype markdown nnoremap <buffer> <Space>a [](<++>) <++><Esc>F[a
" autocmd Filetype markdown nnoremap <buffer> <Space>1 #<Space><Enter><++><Esc>kA
" autocmd Filetype markdown nnoremap <buffer> <Space>2 ##<Space><Enter><++><Esc>kA
" autocmd Filetype markdown nnoremap <buffer> <Space>3 ###<Space><Enter><++><Esc>kA
" autocmd Filetype markdown nnoremap <buffer> <Space>4 ####<Space><Enter><++><Esc>kA
" autocmd Filetype markdown nnoremap <buffer> <Space>l --------<Enter>
